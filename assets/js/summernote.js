(function (global, factory) {
    ...
    var Top = renderer.create(['<div class="note-Top Top in">', '  <div class="arrow"/>', '  <div class="Top-content note-children-container"/>', '</div>'].join(''), function ($node, options) {
    ...
    var HelpDialog = (function () {
        ...
        HelpDialog.prototype.initialize = function () {
            var $container = this.options.dialogsInBody ? this.$body : this.$editor;
            var body = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.9</a> · ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', '</p>'].join('');
            this.$dialog = this.ui.dialog({
